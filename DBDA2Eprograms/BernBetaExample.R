source("DBDA2Eprograms/DBDA2E-utilities.R")  # Load definitions of graphics functions etc.
source("DBDA2Eprograms/BernBeta.R")          # Load the definition of the BernBeta function
